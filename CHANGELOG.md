...
- command line option --start (-s) that automatially starts a specified project. It only works together with -f or -p options (#54)
...
- .gitignore ignores auto-generated files (PR #27)
