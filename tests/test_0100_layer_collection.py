...
def test_layer_collection():
    ...
    # Test 7: Uninitialized state handling
    lc = LayerCollection()  # Fresh instance
    
    # Should handle layer_stack=None
    try:
        lc.number_of_layers()
    ...
    # Should handle master_layer=None
    try:
        lc.copy_master_layer()
