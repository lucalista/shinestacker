...
* If ```exif_path``` is specified, the output image of a stack of 16 bit images is a 8 bit image, even if the stacking algorithm runs with 16 bit representation. ```exif_path=''``` should be used to avoid this artificial conversion to 8 bits.
