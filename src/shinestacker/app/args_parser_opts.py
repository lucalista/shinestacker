...
''')
    ...
    group.add_argument('-e', '--enable-auto-retouch', action='store_const', const=True, dest='auto_retouch',
                       help='''
Enable retouch after run at startup''')
    group.add_argument('-d', '--disable-auto-retouch', action='store_const', const=False, dest='auto_retouch',
                       help='''
